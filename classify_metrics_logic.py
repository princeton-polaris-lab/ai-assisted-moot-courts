...
DATABASE_PATH = "data/logical_fallacies.db"
GET_CASES_QUERY = "SELECT * FROM remark_transcript_logic_context WHERE justice_response_model IN {models_list};"
...
def metrics_main(cfg: DictConfig) -> None:
    ...
    for index, row in cases_df.iterrows():
        ...
        for metric_title in metrics_list:
            ...
            # get logical fallacy
            if row["flaw_exists"] == "True":
                logical_fallacy_type = row["flaw_type"]
            else:
                logical_fallacy_type = "No Fallacy"
